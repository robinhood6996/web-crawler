            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="pendingList">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body table-responsive" id="table_data" style="overflow-x:auto;">
...
<script>
    ...
    function fetch_data(page) {
        ...
        let url = '{{ route('home-pagination-index') }}?status=' + param + '&page=' + page;
        console.log(url);
        $.ajax({
            url: url,
    ...
    function copyToClipboard(text) {
        ...
        //  const text = document.getElementById(id).select();
    ...
    function showDescriptionModal(descriptionData) {
        // Retrieve the description data from the backend using AJAX or fetch request
        // ...
    ...
    const changeHrFr = (e, id) => {
        if (e) {
            ...
            myformData.append('table', 'article');
            myformData.append('id', id);
