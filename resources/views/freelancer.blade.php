...
<script>
    ...
    function fetch_data(page) {
        ...
        let url = '{{ route('freelancer-pagination-index') }}?status=' + param + '&page=' + page;
    ...
    const statusChange = (id, status) => {
        ...
        if (id) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('edit-freelancer-status') }}",
                data: myformData,
                processData: false,
                contentType: false,
                cache: false,
    ...
    const deleteDescription = (id) => {
        ...
        if (id) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('delete-freelancer-description') }}",
                data: myformData,
                processData: false,
                contentType: false,
                cache: false,
    ...
    const changeHrFr = (e, id) => {
        ...
        if (e) {
            ...
            myformData.append('table', 'freelance');
            myformData.append('id', id);
