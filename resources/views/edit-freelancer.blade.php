    ...
    <div class="container" style="margin-top:40px">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <form action="{{ route('update-freelancer-article') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <input type="hidden" value="{{ @$articleData->status }}" id="" name="queryParam" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="file2" value="" class="form-control"
                                            placeholder="Enter ...">
                                        <image class="h-50 w-50" src="{{ asset(@$articleData->file2) }}" alt="no image">
                                        </image>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="file3" value="" class="form-control"
                                            placeholder="Enter ...">
                                        <image class="h-50 w-50" src="{{ asset(@$articleData->file3) }}" alt="no image">
                                        </image>
                                    </div>
                                </div>
                            </div>
